...
| 分组 | 说明 |
|------|------|
| 01-基础数据 | 产能表、产品序列、产品序列物料对应、物料节拍、排程场景 |
| 02-维护订单 | 生产订单录入与管理（PS 视角） |
| 03-执行生产排程 | 排程场景选择、版本发布、汇总结果查看 |
| 04-排程结果对比 | 多版本排程结果横向对比分析 |
| 05-查询排程结果 | 按版本号/生产日期查询排程明细 |
| 06-生产计划查询 | 甘特图视图下的生产计划可视化 |
