...
| --- | --- | --- |
| [01-基础数据](01-基础数据/index.md) | 产能、序列、节拍、排程场景等约束主数据 | 只写期望作用与缺口 |
| [02-维护订单](02-维护订单/index.md) | 排程输入侧订单/需求维护 | 只写与 MES 订单的边界，不抄 MES 字段 |
| [03-执行生产排程](03-执行生产排程/index.md) | 按场景/版本触发排程引擎 | 不写未证实算法参数与公式 |
| [04-排程结果对比](04-排程结果对比/index.md) | 多版本指标横向对比与择优 | 不写未证实指标与优劣阈值 |
| [05-查询排程结果](05-查询排程结果/index.md) | 按版本/日期查排程明细 | 不写未证实明细字段 |
| [06-生产计划查询](06-生产计划查询/index.md) | 计划可视化（如甘特）与发布后查询 | 不写未证实交互与发布规则 |
