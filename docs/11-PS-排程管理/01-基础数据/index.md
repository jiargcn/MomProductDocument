...
| 字段名 | 中文名 | 类型 | 约束 | 影响业务 | 备注 |
|--------|--------|------|------|----------|------|
| sequence_code | 序列编号 | VARCHAR(50) | 必填 | 关联[产品序列](index.md) | |
...
2. **节拍联动**：[物料节拍](index.md) × 产线节拍 → 实际生产速度，修改任一方都会影响排程结果
3. **场景隔离**：不同[排程场景](index.md)独立运行，互不影响
...
| DBC_ROUTING | [工艺路线](../../04-DBC-主数据管理/08-工艺建模/02-工艺路线.md) | 获取工艺路线信息确定产品序列归属 |
| DBC_WORKSHOP | [车间主数据](../../04-DBC-主数据管理/04-工厂建模/06-车间管理.md) | 获取车间/产线信息 |
| MES_PRODUCTION | [生产管理](../../06-MES-生产管理/index.md) | 产线实际产能反馈至产能表 |
