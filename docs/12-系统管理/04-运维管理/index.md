...
业务说「系统坏了」，运维却不知道该查日志、查任务还是查接口——本页就是为了减少这种来回试错。它说明“在系统里如何做运行维护”：查日志、管任务、看交换失败、改高风险配置；平台能力细节在基础设施各页，本页提供**入口地图与风险口径**，避免运维动作与业务补偿混写。读完本页，你能按现象快速定位该进哪个菜单、动手前该确认什么。

## 如何使用本组文档

运维诉求先分类，再挑入口，比挨个菜单试快得多：
