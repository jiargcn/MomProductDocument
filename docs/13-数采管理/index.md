...
> 阅读对象：设备/自动化工程师、实施顾问、运维；各组操作见分组内「维护与查询参考」。
...
本模块**不是** DBC 设备台账、EAM 维修工单、ANDON 呼叫、WMS/AGV 搬运任务的替代页。MES/WMS 可通过 IoT 网关 RPC 查询或下发参数（如点检读数），属消费侧；AGV 另有独立回调入口。
...
| 想找 Node-RED 相关入口 | [NodeRed](03-NodeRed/index.md)（资料薄弱，见该页） |
...
| [03-NodeRed](03-NodeRed/index.md) | Node-RED 管理/日志导航意图 | NodeRed管理、NodeRed日志管理（页面实现薄弱） |
...
| Node-RED 菜单打不开 | 见 [NodeRed](03-NodeRed/index.md) 薄弱说明 | 勿当成完整运维台 |
