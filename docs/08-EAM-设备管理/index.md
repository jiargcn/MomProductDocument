...
EAM 负责设备与工装的**运行维护执行**：验收/移动/变更、停机、报修维修、巡检/保养/点检、备件与 EAM PDA。读完本页，应能判断问题进哪个 EAM 分组，还是回 [DBC 台账](../04-DBC-主数据管理/07-设备管理/index.md) 查身份；并知道备件出入库可同步 WMS，**余额以 WMS 为准**。
...
| 报修、维修、巡检保养、备件、PDA | 按下方学习顺序进本模块分组 |
