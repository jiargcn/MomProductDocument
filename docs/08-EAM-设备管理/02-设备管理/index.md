...
设备坏了该报修给谁、维修单卡在哪一步该催谁——答案都在设备管理里。它回答：设备如何验收投用、如何移动/变更、何时停机、报修与维修如何走到闭环。设备**台账身份**在 DBC 维护（EAM 导航下的「设备台账管理」实际打开 DBC 台账页）；本页写 EAM 执行侧已证实能力，读完能分清「台账问题回 DBC，执行问题看本页」。

不替代 ANDON 异常呼叫与响应链，也不替代 MES 工位作业。旧虚构 ER 字段废弃。

## 如何使用本组文档

想清楚现在卡在哪个环节，再挑对应文档，比通读全页更快：
