...
| [物料库区配置](05-物料库区配置管理.md) | 主文档 + [维护与查询参考](09-物料库区配置管理-维护与查询参考.md) | 已明确当前实际是物料—仓库默认配置，而非库区/库位策略。 | 真实库区策略边界、包装字段一致性和下游影响测试。 |
| [生产线物料关系](06-生产线物料关系管理.md) | 主文档 + [维护与查询参考](10-生产线物料关系管理-维护与查询参考.md) | 已说明产线—物料关系、BOM 查询线索和导入边界。 | 原材料/产成品入口、MES/WMS 实际挂接和详情联查测试。 |
| [标准成本价格单](07-标准成本价格单管理.md) | 主文档 + [维护与查询参考](11-标准成本价格单管理-维护与查询参考.md) | 已明确其为按物料维护的当前标准价格口径，而非多版本自动计价体系。 | 多币种/期间规则、供应商维度、下游取价和零值处理测试。 |
