...
| 页面 | 文档形态 | 已说明内容 | 后续需补 |
| --- | --- | --- | --- |
| [工装台账管理](01-工装台账管理.md) | 待按判定表复核 | 待重构为工装基础资料说明。 | 维护责任、状态、关联工艺/设备和查询。 |
| [设备台账管理](02-设备台账管理.md) | 待按判定表复核 | 待重构为设备基础资料说明。 | 维护责任、与 EAM 边界、联查和变更影响。 |
| [生产商管理](03-生产商管理.md) | 单文档（合并维护与查询） | 待重构为生产方资料说明。 | 新增/停用、设备/工装关联和查询。 |
