...
| 讲清「改业务类型/单据设置 → 单据行为变化」 | [策略设置](05-策略设置/index.md) → [业务类型](05-策略设置/03-业务类型.md)、[单据设置](05-策略设置/04-单据设置.md) |
...
当前可先从[物料基本信息](01-物料管理/01-物料基本信息.md)开始理解 DBC 的典型维护方式。各分组已有业务说明与维护/查询覆盖；部分截图/细则仍待补。
