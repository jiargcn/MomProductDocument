...
**与 EAM 的边界：** [设备台账（DBC）](07-设备管理/index.md)维护设备/工装/生产商等**身份与可引用主数据**；报修维修、巡检保养、备件执行与 PDA 见[EAM 设备管理（运维执行）](../08-EAM-设备管理/index.md)。不要在 DBC 台账页推断保养工单规则，也不要在 EAM 另建第二套身份主数据。
