...
| --- | --- | --- | --- | --- |
| 运行工单状态 | P9 | 能否领活/报工 | 须已下发且可执行 | 待下发不能开干 |
| 任务模式 | P1 / P8 | 报工入口 | 单件/批量/普通批量 | 入口选错必失败 |
| 分派模式 | P1 / P12 | 领取方式 | 抢单/派单（来自工艺节点） | 领不到活 |
| 报工 OK/NG | P1 / P9 | 合格与不良结果 | NG→QMS 自动建单 **未证实**（`GAP-071`） | 写成固定建单 |
| 转序门闸 | P7 / P9 | 能否转下序 | 依赖工艺最小合格/策略 | 堵线 |
| 客户端绑定工位 | P2 / P4 | 可见作业范围 | 与基础建模一致 | 绑错无作业 |
