...
| 模块 | 接口方向 | 说明 |
|------|----------|------|
| DBC_MATERIAL | [物料主数据](../../04-DBC-主数据管理/01-物料管理/01-物料基本信息.md) | 同步物料基础信息至 MES |
| DBC_BOM | [BOM 主数据](../../04-DBC-主数据管理/01-物料管理/02-BOM.md) | 继承标准 BOM 结构，扩展工艺属性 |
| DBC_PROCESS | [工序管理](../../04-DBC-主数据管理/08-工艺建模/01-工序管理.md) | 获取工序字典数据 |
| DBC_ROUTING | [工艺路线](../../04-DBC-主数据管理/08-工艺建模/02-工艺路线.md) | 获取工艺路线数据 |
| DBC_PLANT | [工厂建模](../../04-DBC-主数据管理/04-工厂建模/06-车间管理.md) | 获取车间、产线、工位基础架构 |
| DBC_WORKSHOP | [车间主数据](../../04-DBC-主数据管理/04-工厂建模/06-车间管理.md) | 获取车间组织架构 |
| DBC_PRODUCTION_LINE | [生产线管理](../../04-DBC-主数据管理/04-工厂建模/07-生产线管理.md) | 获取产线配置信息 |
| DBC_WORKSTATION | [工位管理](../../04-DBC-主数据管理/04-工厂建模/08-工位管理.md) | 获取工位配置信息 |
| DBC_SHIFT | [班次管理](../../04-DBC-主数据管理/05-策略设置/01-班次管理.md) | 获取班次定义用于排班 |
| DBC_TEAM | [班组管理](../../04-DBC-主数据管理/05-策略设置/02-班组管理.md) | 获取班组配置 |
| EAM_ASSET | [设备台账](../../08-EAM-设备管理/02-设备管理/index.md) | 设备台账数据用于设备点检配置 |

### 被依赖模块

| 模块 | 接口方向 | 说明 |
|------|----------|------|
| MES_PLANNING | [计划管理](../03-计划管理/index.md) | 产线/工位数据作为工单分配依据 |
| MES_ROUTING | [工艺管理](../02-工艺管理/index.md) | 工序/SOP 数据用于工艺路线配置 |
| WMS_PROD_RECEIVE | [生产收料](../../05-WMS-库房管理/07-生产收料/index.md) | 线边库/料口配置用于投料执行 |
| QMS_IPQC | [生产检验](../../07-QMS-质量管理/03-生产检验/index.md) | 工位能力矩阵用于检验任务分配 |