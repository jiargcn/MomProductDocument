...
| --- | --- | --- | --- | --- |
| 线边客户端↔工位/工序 | P2 / P4 | 决定能领哪些作业 | 绑定须匹配产线 | 绑错领不到活 |
| SOP 挂接层（工序/工位） | P2 / P11 | 现场指导书来源 | 明确以哪层展示为准 | 版本不一致 |
| 工位技能要求 | P2 / P9 | 上岗拦截 | 引用技能/等级 | 过严/过松 |
| 开工点检模板 | P12 / P9 | 开工前检查 | 与计划「待点检」联动 ❓ | 与 EAM 点检混淆 |
| 线边库 WMS 映射 | P2 / P4 | 库存协同键 | 须有效 WMS 仓/库编码 | 对不上发料 |
| 生产 BOM | P2 / P4 / P6 | 工序用料 | 与 DBC BOM 孰为准 ❓（`MES-BASE`） | 用料脱节 |
