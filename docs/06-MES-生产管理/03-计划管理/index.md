...
| 模块 | 接口方向 | 说明 |
|------|----------|------|
| ERP_PURCHASE | [ERP 采购](../../01-总体框架/architecture.md) | 同步 ERP 工单数据作为 MES 执行源头 |
| DBC_MATERIAL | [物料主数据](../../04-DBC-主数据管理/01-物料管理/01-物料基本信息.md) | 获取物料编码、名称、单位等基础信息 |
| DBC_BOM | [BOM 主数据](../../04-DBC-主数据管理/01-物料管理/02-BOM.md) | 获取产品 BOM 结构，用于工单物料清单 |
| DBC_ROUTING | [工艺路线](../../04-DBC-主数据管理/08-工艺建模/02-工艺路线.md) | 获取工序路线，用于工单工艺拆分 |
| DBC_PRODUCTION_LINE | [生产线管理](../../04-DBC-主数据管理/04-工厂建模/07-生产线管理.md) | 获取产线信息，用于工单产线分配 |
| MES_BASIC | [基础建模](../01-基础建模/index.md) | 获取工位、工人、能力矩阵等执行资源 |

### 被依赖模块

| 模块 | 接口方向 | 说明 |
|------|----------|------|
| WMS_PROD_RECEIVE | [生产收料](../../05-WMS-库房管理/07-生产收料/index.md) | 工单投料驱动线边库发料 |
| WMS_PROD_MGMT | [生产管理](../../05-WMS-库房管理/08-生产管理/index.md) | 完工入库触发生产入库流程 |
| QMS_IPQC | [生产检验](../../07-QMS-质量管理/03-生产检验/index.md) | 报工/完工触发过程检验 |
| MES_REPORT | [报表统计](../05-报表统计/index.md) | 工单执行数据作为生产统计来源 |