...
本页讲清生产用料的主线。高低储规则、备料计划、发料申请/任务/记录及补料的字段、状态和权限，需要在后续发料管理-维护与查询参考中按具体页面核验。
...
【截图占位：备料计划、发料任务或补料任务页面，标出需求来源、物料、数量、拣货库位、领用地点和状态。】
...
【示例数据占位：工单需领用 100 件物料，仓库先发 80 件、后补 20 件。展示备料、任务、发料记录、补料和库存变化。】
