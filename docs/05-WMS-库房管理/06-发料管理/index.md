...
发料管理把生产需求转化为仓库可执行的备料、发料和补料工作，使物料在正确时间、以正确数量和追溯维度进入生产现场。它连接生产计划或工单、库存可用量、现场扫码执行和生产用料记录，避免无来源、无记录的随意出库。读完本页，应能判断某工位缺料是发料没做、库存不足还是补料未触发，以及少发/超发后系统留下了什么痕迹。

## 如何使用本组文档

| 你的目的 | 建议阅读 |
| --- | --- |
| 理解生产用料的主线 | 本页：生产用料如何完成 → 关键判断 → 库存影响。 |
| 具体页面、导入、列表、详情与快速跳转 | [发料管理-维护与查询参考](发料管理-维护与查询参考.md)。 |
