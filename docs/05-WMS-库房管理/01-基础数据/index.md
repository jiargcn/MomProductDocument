...
WMS 基础数据把“仓库业务要按什么价格、结算口径和标签规则运行”落实为受控资料。它们不直接完成收货或上架，但决定业务能否被正确解释、打印识别能否成立、结算能否衔接、追溯能否闭环。读完本组文档，应能判断入库链上出现的价格取不到、结算科目对不上、标签打印异常，究竟该回查哪一份基础资料。

## 如何使用本组文档

| 你的目的 | 建议阅读 |
| --- | --- |
| 想理解这组资料如何影响入库链的价格、结算和标签 | 本页「这一组资料解决什么问题」与「与入库链的关系」。 |
| 要新建或维护价格、结算科目、ERP 对照、标签规则 | 按下方「建议学习与维护顺序」逐项进入对应叶页。 |
| 收货/上架中价格、科目或标签异常 | 本页「当前边界与待确认事项」。 |
