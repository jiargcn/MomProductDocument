...
> 阅读对象：客退质量、仓储退货协同；操作见[客户检验-维护与查询参考](客户检验-维护与查询参考.md)。
...
| --- | --- | --- | --- | --- |
| 触发：客户退货记录 | P9 / P12 | 规则开启时可建申请 | 「创建后建检验申请」开关 | 关则无单 |
| 客户/物料/数量 | P2 / P5 | 客退对象 | 多由退货记录带入 | 部分参考订单字段可能置空 |
| 检验类型=客户退货检验 | P1 | 与方案匹配 | 非出货 OQC | 勿当作出货检验页 |
| 评估码 / 使用决策 / ATR 状态 | P1 / P9 | 同来料口径 | 库存归 WMS | — |
