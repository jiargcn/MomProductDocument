...
| WMS_RECEIVING | [采购收货](../../05-WMS-库房管理/03-采购收货/index.md) | 采购收货触发来料检验任务 |
| DBC_MATERIAL | [物料主数据](../../04-DBC-主数据管理/01-物料管理/01-物料基本信息.md) | 获取物料检验属性 |
| DBC_SUPPLIER | [供应商主数据](../../04-DBC-主数据管理/02-供应商管理/01-供应商.md) | 获取供应商信息用于绩效评分 |

### 被依赖模块

| 模块 | 接口方向 | 说明 |
|------|----------|------|
| WMS_RECEIVING | [采购收货](../../05-WMS-库房管理/03-采购收货/index.md) | 检验结果决定收货放行/退货 |
| WMS_RETURN | [采购退货](../../05-WMS-库房管理/04-采购退货/index.md) | 不合格品触发退货申请流程 |
| SCP_SUPPLIER | [供应商](../../10-SCP-供应链平台/01-基础数据/index.md) | 检验结果用于供应商绩效评分 |