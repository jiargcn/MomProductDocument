...
> **主文档齐套**：概述 + 检验配置 / 来料 / 生产 / 客户 / 质量评审五组均已第二轮业务化（主文档 + 维护与查询参考 + 字段证据）。截图实拍与跨模块联调细项属 P2，不阻挡齐套声明。
...
| 分组 | 状态 | 说明 |
| --- | --- | --- |
| [01-检验配置](01-检验配置/index.md) | 已齐套 | 抽样/方法/模板/方案/动态规则/计数器。 |
| [02-来料检验](02-来料检验/index.md) | 已齐套 | 到货确认触发；收货建检已停用。 |
| [03-生产检验](03-生产检验/index.md) | 已齐套 | 四套 ATR；MES 报工 NG→自动建单未证实（`GAP-071`）。 |
| [04-客户检验](04-客户检验/index.md) | 已齐套 | 客户退回检验；非出货 OQC。 |
| [05-质量评审](05-质量评审/index.md) | 已齐套 | 检验评审 ATR + Q1/Q2/Q3；区分 WMS 质量评审菜单。 |
