...
产线一声呼叫响起，谁去处理、多久该有人到场——这些痕迹都沉淀在故障记录里。它记录产线异常的**发生事实**与过程痕迹：谁在何时对哪台设备/模具/工单发起呼叫，问题分类与来源是什么，处理措施与附件是什么。它不替代 EAM 维修工单，也不替代 QMS 检验记录；来源码已预留安东异常、设备巡检、质量检验。读完本页，你能分清「呼叫记录」和「维修工单」是两件事，别拿一个当另一个的证据。

旧稿虚构的英文等级状态机与 REST 示例废弃。

## 如何使用本组文档

呼叫记录、响应配置、维修转出分属不同页，按目的对号入座：
