...
ANDON 记录产线异常呼叫与过程到岗，并配置问题响应链、消息与停机项目。读完本页，应能分清「异常怎么记下来」与「怎么通知到人」各在哪组，以及何时转 EAM 报修、勿与 MES 报工或 QMS 检验混用。
...
| 你的目的 | 建议怎么做 |
| --- | --- |
| 理解呼叫与到岗主线 | 本页：模块职责 → 核心流程 → 边界 |
| 查/维护问题主记录 | [故障记录](01-故障记录/index.md) |
| 配响应链与消息 | [问题响应](02-问题响应/index.md) |
| 异常要转设备维修 | EAM [设备管理](../08-EAM-设备管理/02-设备管理/index.md) |
