...
| --- | --- | --- | --- | --- |
| 关联订单号 / 计划号 | P2 / P5 | 可发来源与上限 | 须已发布/可发；带回可发量 | 来源错→超发或拒收 |
| 申请状态 | P9 | ATR 门禁 | 复用通用请求状态（NEW…COMPLETED） | 非法提交 |
| 到仓 / 月台 / 时间窗 | P2 / P4 / P10 | 到货安排 | 仓→月台级联 | 到错仓 |
| 承运 / 车牌 / 计划到货 | P2 / P5 | 物流协同 | 记录侧沉淀 | — |
| ASN 号 | P6 / P5 | 仓库识别键 | 形成记录后生成/带入 | ASN 失败则 WMS 无单 |
| 明细数量/包装/批次 | P7 / P8 | 发运内容 | 受订单/计划未交约束 | 超未交量 |
| 是否已建收货申请 | P1 / P5 | 防重复 | 标志+申请号 | 重复建单 |
| SCP→WMS 推送 | P12 | 协同落地 | 成功才有仓库可收对象 | 勿假定库存已变 |
