...
**Architecture:** QMS 先做一次共享事实层（申请—任务—记录、状态/判定、触发回写）再五路并行回填；MES 主文档已齐套，并行做 P2 收口（链接修正、待确认入账、跨模块边界抽样）。正式页只写业务，技术证据下沉 `project-docs/10-按需查阅/资料与证据/`。
...
| 字段证据目录 | 无或极少 | `project-docs/10-按需查阅/资料与证据/字段证据/QMS/` |
...
- [ ] `project-docs/10-按需查阅/资料与证据/字段证据/QMS/<分组>.md`
- [ ] `mkdocs.yml` 挂上维护参考
...
**产出：** `project-docs/10-按需查阅/资料与证据/字段证据/QMS/检验执行事实层总览.md`（可另附状态枚举摘录）
...
- 新增 `project-docs/10-按需查阅/资料与证据/字段证据/QMS/检验配置.md`
