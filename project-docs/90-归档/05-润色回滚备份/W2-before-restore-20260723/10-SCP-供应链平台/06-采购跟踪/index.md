...
> 阅读对象：**测试、实施（主）**；采购跟单、供应商查询（顺带）。操作见[采购跟踪-维护与查询参考](采购跟踪-维护与查询参考.md)。售前停在[模块首页](../index.md)。
...
| 本分组覆盖 | 不在本分组 |
| --- | --- |
| SCP 侧收货/退货/短缺等跟踪视图与对象 | WMS 库内收货任务执行与库存权威 |
| 与 ASN/PO 联查 | 承诺 SCP 单独完成全部仓内闭环 |
