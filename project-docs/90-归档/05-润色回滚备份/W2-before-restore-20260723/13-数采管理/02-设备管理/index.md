...
> 阅读对象：**测试、实施（主）**；设备/自动化工程师、运维（顺带）。操作见[设备管理-维护与查询参考](设备管理-维护与查询参考.md)。售前停在[模块首页](../index.md)。
...
| 本分组覆盖 | 不在本分组 |
| --- | --- |
| 采集设备、采集日志、MQTT 监控 | 采集点/参数项配置 → [采集点](../01-采集点/index.md) |
| 与 DBC/EAM「设备」概念边界说明 | DBC 台账身份；EAM 报修维修 |
...
| --- | --- |
| 设备—日志—MQTT 关系 | **本页** |
| 建档设备或查日志 | [设备管理-维护与查询参考](设备管理-维护与查询参考.md) |
| 配采集点与参数项 | [采集点](../01-采集点/index.md) |
| 消费侧如何用读数 | [数采与边缘接入模型](../04-数采与边缘接入模型.md)、MES 点检相关页 |
| 售前 | [数采模块首页](../index.md)；勿承诺与 DBC 自动同步 |
