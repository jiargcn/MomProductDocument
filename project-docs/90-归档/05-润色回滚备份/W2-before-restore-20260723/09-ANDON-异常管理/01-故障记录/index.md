...
> 阅读对象：**测试、实施（主）**；班组长、安灯管理员（顺带）。操作见[故障记录-维护与查询参考](故障记录-维护与查询参考.md)。售前停在[模块首页](../index.md)。
...
| 本分组覆盖 | 不在本分组 |
| --- | --- |
| 问题主记录、过程到岗、停机项目引用 | 响应链配置主维护 → [问题响应](../02-问题响应/index.md) |
| 转维修线索字段 | EAM 报修审批与维修状态机 |
...
| --- | --- |
| 异常事实长什么样、主线 | **本页** |
| 登记/关闭呼叫、查过程 | [故障记录-维护与查询参考](故障记录-维护与查询参考.md) |
